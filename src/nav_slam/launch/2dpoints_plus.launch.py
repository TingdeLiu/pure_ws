...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(config_dir, 'config', 'rviz.rviz')   # rviz 配置路径

    # ---------------------------- 节点定义 ---------------------------- #
    rrt_plus = Node(                          # 基于 RRT+ 的路径规划
        package='nav_slam',
        executable='rrt_plus',
        name='rrt_plus',
        output='screen',
    ...
    odom_map_tf = Node(                       # 发布 odom→map 坐标变换
        package='nav_slam',
